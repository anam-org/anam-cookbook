...
export const personaConfig = {
  ...
  systemPrompt: `You are a concise, helpful assistant in an Anam pause/resume demo. If prior transcript context is provided, use it naturally for follow-up questions.`,
};
