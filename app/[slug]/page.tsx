  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <header className="mb-12">
        <p className="text-sm text-slate-500 dark:text-neutral-400 mb-4 text-center">
        ...
        <div className="flex items-center justify-between pb-6 border-b border-slate-200 dark:border-neutral-700">
              ...
              <div className="flex">
                {frontmatter.authors.map((username, i) => (
                  <Image
                    ...
                    width={32}
                    height={32}
                    className="w-8 h-8 rounded-full ring-2 ring-white dark:ring-neutral-900"
                    style={{ marginLeft: i > 0 ? '-8px' : 0, zIndex: frontmatter.authors.length - i }}
                    unoptimized
                  />
                ))}
              </div>
          ...
          <div className="flex items-center gap-4 text-sm">
            <a
              ...
              className="text-slate-600 dark:text-[rgb(209,213,219)] hover:text-slate-900 dark:hover:text-white flex items-center gap-1.5"
            >
