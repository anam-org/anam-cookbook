...
## Step 1: Create a Custom LLM Persona

First, create a persona configured for custom LLM mode in Anam Lab, or via the API:
...
const persona = await fetch('https://api.anam.ai/v1/personas', {
  ...
  body: JSON.stringify({
    name: 'My Custom LLM Agent',
    avatarId: 'your-avatar-id',
    voiceId: 'your-voice-id',
    llmId: 'CUSTOMER_CLIENT_V1', // This disables the built-in LLM and enables custom LLM mode
  }),
});
```
...
async function startCustomLLMSession() {
