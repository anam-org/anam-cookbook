...
description: "Add an Anam AI avatar widget to your WordPress site using a simple HTML block or plugin — no coding required."
...
Open your persona in the [Anam Lab](https://lab.anam.ai) editor, select **Embed**, and choose **Widget**.

Add your website origin under **Allowed Domains**, select **+**, and select **Publish**. Add the origin visitors actually use, including any custom domain. For example, `https://example.com` and `https://www.example.com` need separate entries. See the [domain allowlisting guide](https://anam.ai/docs/embed/widget/installation#domain-allowlisting) for origin formats and matching rules.

Then copy the widget embed snippet. It looks like this:
...
The full list of attributes is in the [widget documentation](https://anam.ai/docs/embed/widget/configuration).
