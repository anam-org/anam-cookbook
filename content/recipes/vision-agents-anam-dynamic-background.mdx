...
![Generate an avatar in front of a green screen](/img/vision-agents/generate-avatar.png)

The generated avatar will popuplate the list and should look something like this:
![Generated avatar in the Anam Lab](/img/vision-agents/avatar-green-screen.png)
...
Docs: [Vision Agents](https://visionagents.ai), [Anam](https://anam.ai/docs).
