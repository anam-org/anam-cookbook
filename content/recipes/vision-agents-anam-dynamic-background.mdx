...
To simplify the background replacement, we'll use a simple green screen setup, where the green screen pixels are replaced by the co-located pixels from the scene background. If you do not have an avatar with a green screen, you can use the Persona build page [Anam Lab](https://lab.anam.ai/build) to create one.
...
Docs: [Vision Agents](https://visionagents.ai), [Anam](https://anam.ai/docs/introduction/overview).
