...
The `ANAM_AVATAR_ID` can be found in the build page [lab.anam.ai/build](https://lab.anam.ai/build) by hovering over an avatar and clicking the three dots menu.
</tip>
