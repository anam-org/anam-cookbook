...
<Info>
This section will be expanded with detailed agent configuration guidance. For now, configure your agent in the [ElevenLabs dashboard](https://elevenlabs.io) following their standard documentation.
</Info>

A few quick tips:

- Use a V3 Conversational voice for the most expressive output
- Keep the agent's system prompt short. Shorter prompts reduce first-response latency
- Test your agent in the ElevenLabs playground before connecting it to Anam
