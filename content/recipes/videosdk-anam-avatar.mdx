...
In this example, the TTS output goes to the avatar, which returns a lip-synced video stream (synchronized audio/video) that is published in your VideoSDK room. Full example: [Anam Cascading Example on GitHub](https://github.com/videosdk-live/agents/blob/main/examples/avatar/anam_cascading_example.py).
...
Docs: [VideoSDK AI Agents](https://docs.videosdk.live/ai_agents/overview), [Anam](https://anam.ai/docs/introduction/overview).
