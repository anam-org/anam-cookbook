...
Open one websocket context with `add_timestamps=True` and push each segment's text. Request raw 24 kHz PCM to match Anam's recommended minimum sample rate for avatar performance.
