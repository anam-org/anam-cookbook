...
description: "Embed an Anam AI avatar widget on your Shopify store with a simple script tag — no coding required."
...
Check the [widget documentation](https://anam.ai/docs/embed/widget/configuration) for the full list of attributes.
