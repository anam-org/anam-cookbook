...
<Warning>
**A newer client-side integration is now available.** If you are still looking for a client-side integration, see the [Expressive Voice Agents with ElevenLabs and Anam Avatars (Client-Side)](/recipes/elevenlabs-expressive-voice-agents) cookbook for a simpler, more efficient approach.
</Warning>
