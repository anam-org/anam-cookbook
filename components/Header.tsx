...
export function Header({ recipes = [] }: HeaderProps) {
  ...
  return (
    <>
      <header className="border-b border-slate-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4 text-sm">
            ...
            <Link
              ...
              className="text-slate-600 dark:text-neutral-400 hover:text-slate-900 dark:hover:text-neutral-100 transition-colors flex items-center gap-1"
            >
              API Reference
